...
public class Mine2 extends JFrame {
	JTextField text;
...
class Frame1_start_actionAdapter implements ActionListener {
	private Mine2 adaptee;

	Frame1_start_actionAdapter(Mine2 adaptee) {
...
class Bomb_actionAdapter implements ActionListener {
	...
	Bomb_actionAdapter(Mine2 adaptee) {
		this.adaptee = adaptee;
	}
...
class Bomb_mouseAdapter extends MouseAdapter {
	...
	Bomb_mouseAdapter(Mine2 adaptee) {
		this.adaptee = adaptee;
	}
